            ...
            <PageWrapper>
                ...
                then you may reveal the answer. After testing the card, you are to rate the card<br />
                    ...
                    <b>Mark as Duplicate</b>  If two or more cards are very similar or duplicate of each other, press "mark as duplicate" on one of the cards and
                     choose one or more of the other cards. Marking as duplicate goes both ways, but this is handled automatically.
                     <br /> <br />
                ...
                <Progress x={ratings.filter(rating => rating.difficulty > 0 && rating.quality_rating > 0).length} y={peerreview.reviewsDue} body="Card ratings submitted" style={{ width: "300px", marginLeft: "auto", marginBottom: "30px" }} />
                <Divider />
                ...
                {ratings.length ?
                    ...
                    ratings.map((rating, i) =>
                        <React.Fragment>
                            <RateCard key={rating.id} rating={rating} index={i + 1} save={save} previewCard={openPreviewCard} />
                            <Divider />
                        </React.Fragment>
                    ) : <div>empty</div>}
            </PageWrapper>
