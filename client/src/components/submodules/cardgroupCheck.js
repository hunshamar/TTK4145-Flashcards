...
const CardgroupCheck = ({
  cardgroups,
  checkedCardgroups,
  setCheckedCardgroups,
}) => {
  ...
  const handleChange = (e) => {
    ...
    if (checked) {
      ...
      setCheckedCardgroups(
        checkedCardgroups.filter((checked_id) => checked_id !== id)
      );
    }
  };
  ...
  if (!cardgroups.length) {
    return (
      <Typography variant="body" color="textSecondary">
        No cardgroups in collective deck
      </Typography>
    );
  }
          ...
          <FormControlLabel
            ...
            control={
              <Checkbox
                ...
                checked={checkedCardgroups.includes(cardgroup.id)}
                onChange={handleChange}
                id={cardgroup.id.toString()}
              />
            }
