...
const UserDeck = ({cardDeck}) => {
    ...
    const deleteCardDeck = () =>{
        ...
        if (window.confirm("Are you sure you want to delete flash card deck '" + cardDeck.title + "'?")) {
    ...
    return(
        ...
        <CardActions className={classes.actions} >
             <Button fullWidth startIcon={<DeleteIcon />} onClick={deleteCardDeck} variant="outlined">Delete Deck</Button>
        </CardActions>
      </Card>
    );
}
